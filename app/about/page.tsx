    ...
    <>
      <main className="container mx-auto">
        ...
        <section>
          ...
          <h3>1. how I begun</h3>
          <p>
            I acquired my software engineering skills through hands-on
            experience in the real world while working part-time in 2015. It was
            during the winter break of my graduate school program, where I was
            assigned simple office tasks. The project involved converting an ERP
            system written in DOS into a GUI-based system.
          </p>
          <p>
            ...
            allowed real-time data sharing through files. This revelation gave
            me the confidence that the conversion was achievable. Encouraged by
            this, I dared to ask if I could take on the task of converting the
            system.
          </p>
          <p>
          ...
          <p>
            ...
            software development journey. Surprisingly, there was hardly any
          ...
          <p>
            ...
            which introduced me to the world of machine learning. This deepened
            my passion for coding even more. For my final project, I utilized
            ...
            responsibly and ethically, which further enhanced my understanding
            of the broader implications of coding and data manipulation.
          </p>
          <h4>3. how I entered the dev world</h4>
          <p>
            After the Covid break, I returned to my home country. I liked
            research but had a stronger desire for stable income from having a
            job. To pursue a career in software development, I enrolled in a
            bootcamp that offered courses on Java, SQL, HTML, JavaScript, and
            the Spring framework. Learning Java and SQL during the bootcamp was
            an enriching experience, with a particular highlight being the
            introduction to the concept of object-oriented programming (OOP). I
            found OOP to be philosophically beautiful, as it provided a
            structured and elegant approach to software design. My previous
            experience working with relational data proved to be immensely
            helpful as I delved into SQL. It was like fitting together puzzle
            pieces seamlessly. I built various portfolios during the bootcamp,
            showcasing my skills, and eventually landed my first job as a
            backend developer. It was an exciting step forward in my career
            journey.
          </p>
          <p>
            The first task at hand was to analyze the existing data structures
            as the company planned to migrate from a monolithic system to a
            microservices architecture (MSA) while also incorporating a hybrid
            setup. This task presented its challenges, given the numerous
            services already in production. Our team decided to begin by
            identifying and separating points of interest. I took the lead in
            creating diagrams as a draft and collaborating with the team to
            discuss the proposed changes.
          </p>
          <p>
            While my senior focused on maintaining the existing services and
            leading backend service, my role involved developing new APIs for
            the homepage CMS, authentication, and the point system.
            Additionally, I was responsible for building a simple API gateway
            and a migration program. As the company had chosen a specific tech
            stack, I took it upon myself to learn TypeScript, NodeJS,
            Express/NestJS, TypeORM, and Swagger. These experiences were
            invaluable in teaching me not only the importance of development
            itself but also the significance of effective teamwork and
        ...
        <section>
          ...
          <p>
            I know I have to fill the gaps on the fundamental of computer
            science. - started UoL distance learning - udemy, coursera
          </p>
          ...
          <p>
            I just want to enjoy making. There are so many tools that I can
            reach and good tutorials to follow. Adding a little bit more
            creativity will be my main method to grow. I have a lot of idea list
            to bulid, and I can&apos;t wait for playing with it!
          </p>
        </section>
        <section>
          <h2>Skills</h2>
